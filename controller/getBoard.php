...
// SELECT m.nickname, b.b_code, b.title, b.date, b.viewcount, b.textbox FROM board b LEFT JOIN member m ON m.m_code=b.m_code ORDER BY b.date DESC;
$boardCount = $db->count;

// 반환된 레코드를 result 배열에 저장
$result['board_count'] = $boardCount;
