<form id="regist_form" method="post" action="../controller/putRegist.php" name="registForm">
    <div id="top-contents">
        ...
        <div class="form-group">
            ...
            <input type="password" name="passwd" class="form-control" id="exampleInputPassword1" placeholder="비밀번호 입력" onkeydown="enter()">
        </div>
        <br>
        <div class="form-group">
            <label for="exampleInputPassword2">비밀번호 확인</label>
            <input type="password" name="passwd_check" class="form-control" id="exampleInputPassword2" placeholder="비밀번호 확인" onkeydown="enter()">
        </div>
        <br>
        <div class="form-group">
            <label for="exampleInputPassword2">성명</label>
            <input type="text" name="name" class="form-control" id="exampleInputPassword2" placeholder="성명 입력" onkeydown="enter()">
        </div>
        <br>
        <div class="form-group">
            <label for="exampleInputPassword2">닉네임</label>
            <input type="text" name="nickname" class="form-control" id="exampleInputPassword2" placeholder="닉네임 (10자 이하)" onkeydown="enter()">
        </div>
        <br>
        <div class="form-group">
            <label for="exampleInputEmail1">이메일</label>
            <input type="email" name="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="이메일 입력" onkeydown="enter()">
